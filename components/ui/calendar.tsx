    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                month: 'space-y-4 text-slate-800',
                caption: 'flex justify-center pt-1 relative items-center mb-4',
                caption_label: 'text-sm font-semibold text-slate-800',
                nav: 'space-x-1 flex items-center',
                nav_button: cn(
                    'h-7 w-7 bg-slate-100 border border-slate-200 rounded-full flex items-center justify-center p-0 text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 hover:border-indigo-200 transition-all z-20'
                ),
                ...
                head_cell: 'text-center text-xs font-medium text-slate-500 py-1 w-9',
                ...
                day: cn(
                    'h-9 w-9 p-0 font-medium aria-selected:opacity-100 hover:bg-slate-100 rounded-md transition-all duration-200 text-slate-700 hover:text-slate-900 active:scale-95 inline-flex items-center justify-center'
                ),
                day_selected:
                    'bg-indigo-600 text-white hover:bg-indigo-600 focus:bg-indigo-600 shadow-md shadow-indigo-200 font-bold',
                selected:
                    'bg-indigo-600 text-white hover:bg-indigo-600 focus:bg-indigo-600 shadow-md shadow-indigo-200 font-bold',
                day_today: 'bg-indigo-50 text-indigo-600 border border-indigo-200 font-semibold',
                today: 'bg-indigo-50 text-indigo-600 border border-indigo-200 font-semibold',
                day_outside: 'text-slate-300 opacity-60 hover:opacity-100 transition-opacity',
                outside: 'text-slate-300 opacity-60 hover:opacity-100 transition-opacity',
                day_disabled: 'text-slate-300 opacity-30',
                disabled: 'text-slate-300 opacity-30',
                day_range_middle:
                    'aria-selected:bg-indigo-100 aria-selected:text-indigo-700',
                range_middle:
                    'aria-selected:bg-indigo-100 aria-selected:text-indigo-700',
